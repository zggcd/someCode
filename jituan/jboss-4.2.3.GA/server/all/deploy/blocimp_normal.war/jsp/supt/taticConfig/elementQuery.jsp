...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    ...
    <tr style="display:display">
      ...
      <td>
         <input type="text" name="elementcode" ><a href="http://localhost:8888/workorder/browser/1003180024111131.htm">1003180024111131</a>
      </td>
      <td>
...
<script>
initTabs('tabView1',Array('策略元素列表'),0,'100%','100%');
function getDetail(elementid,name){
	createNewTab('tabView1','元素{'+name+'}','','/supt/taticConfigAction.do?method=taticElementDetail&elementid='+elementid,true);
}

function toAdd(){
    createNewTab('tabView1','新增元素','','/supt/taticConfigAction.do?method=taticElementDetail',true);
}
...
function delElement(){
  ...
  if(confirm("您确认要删除选中记录吗？")){
    taticConfigAction.delElement(checkids,goBack);
  }
}

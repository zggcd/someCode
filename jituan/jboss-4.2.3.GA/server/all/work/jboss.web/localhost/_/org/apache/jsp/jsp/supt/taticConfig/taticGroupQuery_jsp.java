...
public final class taticGroupQuery_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	response.setHeader("Expires", "0");
      ...
      out.write("      </td>\r\n");
      out.write("      <td>\r\n");
      out.write("         <input type=\"text\" name=\"taticgoupname\" >\r\n");
      out.write("      </td>\r\n");
      out.write("      <td>\r\n");
      ...
      out.write("         <input type=\"button\" class=\"button\" value=\"删除\" accesskey=\"R\"  onclick=\"delElement()\" />\r\n");
      out.write("      </td>\r\n");
      out.write("  </tr>\r\n");
      out.write("\r\n");
      out.write(" </form>\r\n");
      ...
      out.write("</table>\r\n");
      out.write("<script>\r\n");
      out.write("initTabs('tabView1',Array('策略组列表'),0,'100%','100%');\r\n");
      out.write("function getDetail(id,name){\r\n");
      out.write("\tcreateNewTab('tabView1','策略组{'+name+'}','','/supt/taticConfigAction.do?method=taticGroupDetail&taticgoupid='+id,true);\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function toAdd(){\r\n");
      out.write("    createNewTab('tabView1','新增策略组','','/supt/taticConfigAction.do?method=taticGroupDetail',true);\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      ...
      out.write("    taticConfigAction.delTaticGroup(checkids,goBack);\r\n");
      out.write("  }\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      ...
      out.write("\t\ttaticConfigAction.taticGroupList(formObj,showResultList);\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      ...
      out.write("     if (!validateForm(detailForm, 1)) {\r\n");
      out.write("            return false;\r\n");
      out.write("        }\r\n");
      out.write("    var elementCheckids=getSelectCheckboxValue(\"detailForm\",\"elementCheckid\",\"|\");\r\n");
      out.write("    if(elementCheckids==\"\"){\r\n");
      out.write("       alert(\"请选择此策略组包含的元素！\");\r\n");
      out.write("       return;\r\n");
      out.write("    }\r\n");
      out.write("    var formObj=$('detailForm').serialize(true);\r\n");
      out.write("    formObj.elementCheckids=elementCheckids;\r\n");
      out.write("    taticConfigAction.saveTaticGroup(formObj,goBack);\r\n");
      out.write("}\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function selectElement(){\r\n");
      out.write("     var  returnval=window.showModalDialog(\"/jsp/supt/taticConfig/selectElementList.jsp?d=\"+new Date(),window,\"scroll:yes;status:no;help:0;resizable:0;dialogWidth:800px;dialogHeight:500px\");\r\n");
      out.write("     var elementCheckids=\"|\"+getSelectCheckboxValue(\"detailForm\",\"elementCheckid\",\"|\")+\"|\";\r\n");
      out.write("     if(returnval!=null&&returnval!=\"undefined\"){\r\n");
      out.write("        var ids=returnval.split(\"`~`\")[0];\r\n");
      out.write("        var names=returnval.split(\"`~`\")[1];\r\n");
      out.write("        var id=ids.split(\"|\");\r\n");
      out.write("        var name=names.split(\"|\");\r\n");
      out.write("        var str=$('elementSpan').innerHTML;\r\n");
      out.write("        for(var i=0;i<id.length;i++){\r\n");
      out.write("           if(elementCheckids.indexOf(\"|\"+id[i]+\"|\")==-1){\r\n");
      out.write("              str=str+\"<input type='checkbox' name='elementCheckid' checked value=\"+id[i]+\">\"+name[i]+\";\";\r\n");
      out.write("          }\r\n");
      out.write("        }\r\n");
      out.write("        $('elementSpan').innerHTML = str;\r\n");
      out.write("     }\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");

...
public final class sysModuleManager_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	response.setHeader("Expires", "0");
      ...
      out.write("\t\t\r\n");
      out.write("\t\tdocument.forms[0].action = \"/sys/sysModuleAction.do?method=toSysModuleView\";\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction sysModuleAdd ()\r\n");
      out.write("\t{\r\n");
      out.write("\t\tvar id=tree.getSelectedItemId();\r\n");
      out.write("\t\tif(id==\"\")\r\n");
      out.write("\t\t{\r\n");
      out.write("\t\t\tdocument.forms[0].moduleId.value=\"-1\";\r\n");
      out.write("\t\t} else {\r\n");
      out.write("\t\t\tdocument.forms[0].moduleId.value=id;\r\n");
      out.write("\t\t\tvar parentId=tree.getParentId(id);\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tdocument.forms[0].action = \"/sys/sysModuleAction.do?method=toSysModuleAdd\";\r\n");
      out.write("\t    document.forms[0].target = \"list_page\";\r\n");
      out.write("\t    document.forms[0].submit();\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction sysModuleEdit()\r\n");
      out.write("\t{\r\n");
      out.write("\t\tvar id=tree.getSelectedItemId();\r\n");
      out.write("\t\tif(id!=\"\")\r\n");
      out.write("\t\t{\r\n");
      out.write("\r\n");
      out.write("\t\t\tdocument.forms[0].moduleId.value=id;\r\n");
      out.write("\t\t\tdocument.forms[0].action = \"/sys/sysModuleAction.do?method=toSysModuleEdit\";\r\n");
      out.write("\t\t    document.forms[0].target = \"list_page\";\r\n");
      out.write("\t\t    document.forms[0].submit();\r\n");
      out.write("\r\n");
      out.write("\t\t}else\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction sysModuleDel()\r\n");
      out.write("\t{\r\n");
      out.write("\t\tvar id=tree.getSelectedItemId();\r\n");
      out.write("\t\tif(id!=\"\")\r\n");
      out.write("\t\t{\r\n");
      ...
      out.write("\t\t\t{\r\n");
      out.write("\t\t\t\t\tdocument.forms[0].moduleId.value=id;\r\n");
      out.write("\t\t\t\t\tsysModuleAction.deleteDataSysModule($('moduleId').value,delCallback);\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction sysModuleSave()\r\n");
      out.write("\t{\r\n");
      out.write("\t\tlist_page.window.addTabViewDoSave();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction sysModuleCancel(updateParent)\r\n");
      out.write("\t{\r\n");
      ...
      out.write("\t        \t<input type=\"button\" class=\"button\" value=\"添加\" id=\"btnAdd\" name=\"btnAdd\" onclick=\"sysModuleAdd ()\" >\r\n");
      out.write("\t\t\t\t<input type=\"button\" class=\"button\" value=\"修改\" id=\"btnEdit\" disabled name=\"btnEdit\" onclick=\"sysModuleEdit ()\" >\r\n");
      out.write("\t\t\t\t<input type=\"button\" class=\"button\" value=\"删除\" id=\"btnDel\" disabled name=\"btnDelave\" onclick=\"sysModuleDel ()\" >\r\n");
      out.write("\t\t\t\t<input type=\"button\" class=\"button\" value=\"保存\" id=\"btnSave\" disabled name=\"btnSave\" onclick=\"sysModuleSave ()\" >\r\n");
      out.write("\t\t\t\t<input type=\"button\" class=\"button\" value=\"取消\" id=\"btnCancel\" disabled name=\"btnCancel\" onclick=\"sysModuleCancel (0)\" >\r\n");
      out.write("\t\t\t\t \r\n");
      ...
      out.write("\">\r\n");
      out.write("\t\t\t\t<input type=\"hidden\" id=\"moduleId\" name=\"moduleId\">\r\n");
      ...
      out.write("    tree.setXMLAutoLoading(\"/sys/sysModuleAction.do?method=showTreeWithType\");\r\n");
      out.write("    tree.loadXML(\"/sys/sysModuleAction.do?method=showTreeWithType&id=0\");\r\n");
      out.write("\r\n");

...
public final class protocolAdd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	response.setHeader("Expires", "0");
      ...
      out.write("</script>\r\n");
      out.write("<body>\r\n");
      out.write("\t<form name=\"ifaceConfigProtocolAddForm\">\r\n");
      ...
      out.write("\t\t\t\t                            <td width=\"40%\">新增接口系统配置</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td align=\"left\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"inputtext01\" name=\"remoteHost\" maxlength=\"200\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td noWrap bgcolor=\"#F4F4F4\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div align=\"right\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t    FTP端口:\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"inputtext01\" name=\"wsdlAddr\" maxlength=\"200\" size=\"80\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\r\n");
      out.write("\tvar paramObj = window.dialogArguments;\r\n");
      out.write("\r\n");
      out.write("\tinitIfaceConfigProtocolAdd();\r\n");
      out.write("\t\r\n");
      out.write("\tfunction initIfaceConfigProtocolAdd() {\r\n");
      out.write("\t\ttrimForm();\r\n");
      ...
      out.write("    \tif (!validateForm(ifaceConfigProtocolAddForm, 1)) {\r\n");
      out.write("            return false;\r\n");
      out.write("        }\r\n");
      out.write("\t\tvar formObj = $('ifaceConfigProtocolAddForm').serialize(true); \r\n");
      out.write("    \tifaceConfigProtocolAction.insertIfaceConfigProtocolRecord(formObj,callBackDoSave);\r\n");
      out.write("    }\r\n");
      out.write("    \r\n");
      ...
      out.write("    \tif(obj.readOnly == true){\r\n");
      out.write("    \t\talert('命名空间只有当协议名称为wx时才有效.');\r\n");
      out.write("    \t\treturn false;\t\r\n");
      out.write("    \t}\r\n");
      out.write("    }\r\n");
      out.write("    \r\n");
  ...
  private boolean _jspx_meth_blocimp_005fsysDicDis_005f0(PageContext _jspx_page_context)
    ...
    // /jsp/iface/protocol/protocolAdd.jsp(100,15) name = iddValue type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_blocimp_005fsysDicDis_005f0.setIddValue("PROTOCOL_TYPE");
    // /jsp/iface/protocol/protocolAdd.jsp(100,15) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_blocimp_005fsysDicDis_005f0.setValue("protocolName");
    // /jsp/iface/protocol/protocolAdd.jsp(100,15) name = dicItemIn type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null

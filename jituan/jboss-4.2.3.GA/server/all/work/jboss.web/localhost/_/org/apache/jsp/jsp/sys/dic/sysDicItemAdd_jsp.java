...
public final class sysDicItemAdd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<script type='text/javascript' src='/dwr/interface/sysDicItemAction.js'></script>\r\n");
	...
	response.setHeader("Expires", "0");
      ...
      out.write("        enableForm(\"addSysDicItemForm\");\r\n");
      out.write("        return false;\r\n");
      out.write("    }\r\n");
      out.write("    \r\n");
      out.write("</script>\r\n");
      out.write("<body>\r\n");
      out.write("\t<form name=\"addSysDicItemForm\">\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"dictionaryId\" value=\"\" />\r\n");
      ...
      out.write("\t\t\t\t                            <td width=\"40%\">新增数据字典条目</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"inputtext01\" name=dictionaryName maxlength=\"64\" readOnly style=\"width:85%;border:0 0 0 0\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td noWrap bgcolor=\"#F4F4F4\" width=\"35%\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td align=\"left\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"inputtext01\" name=\"itemValue\" maxlength=\"64\" style=\"width:85%\" dataType=\"Require\" msg=\"数据字典名称不能为空\" />\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td align=\"left\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"inputtext01\" name=\"itemCode\" maxlength=\"64\" style=\"width:85%\" dataType=\"Require\" msg=\"数据字典代号不能为空\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<font color=\"red\">*</font>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td align=\"left\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<textarea name=\"itemDesc\" type=\"text\" rows=\"8\"  style=\"width:85%\" class=\"inputtext01\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td colspan=\"2\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"button\" class=\"button\"  onClick=\"sysDicItemSave();\" value=\"保存\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"button\" class=\"button\"  onClick=\"sysDicItemCancel();\" value=\"取消\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</table>\r\n");
      ...
      out.write("\t\r\n");
      out.write("\tvar dictionaryId = window.dialogArguments;\r\n");
      out.write("\t\r\n");
      out.write("\tinitSysDicConfigIdAndName();\r\n");
      out.write("\t\r\n");
      out.write("\tfunction initSysDicConfigIdAndName() {\r\n");
      out.write("\t\tsysDicConfigAction.getDataSysDicConfig(dictionaryId,callbackInit);\r\n");
      out.write("\t\tdisableForm();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction callbackInit(obj) {\r\n");
      out.write("\t\tenableForm();\r\n");
      out.write("\t\t$('dictionaryName').value = obj.dictionaryName;\r\n");
      out.write("\t\t$('dictionaryId').value = obj.dictionaryId;\r\n");
      out.write("\t\ttrimForm();\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("    function sysDicItemCancel() {\r\n");
      out.write("    \twindow.close();\r\n");
      out.write("    }\r\n");
      out.write("    \r\n");
      out.write("    function sysDicItemSave() {\r\n");
      out.write("    \tif (!validateForm(addSysDicItemForm, 1)) {\r\n");
      out.write("            return false;\r\n");
      out.write("        }\r\n");
      out.write("\t\tvar formObj = $('addSysDicItemForm').serialize(true); \r\n");
      out.write("    \tsysDicItemAction.addDataSysDicItem(formObj,callBackDoSave);\r\n");
      out.write("    }\r\n");
      out.write("    \r\n");

...
public final class sysParameterConfSrch_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	response.setHeader("Expires", "0");
      ...
      out.write("      </td>\r\n");
      out.write("      <td>\r\n");
      out.write("         <input type=\"text\" name=\"parName\" >\r\n");
      out.write("      </td>\r\n");
      out.write("      <td>\r\n");
      out.write("         <input type=\"button\" class=\"button\" value=\"查询(Q)\" accesskey=\"Q\"  onclick=\"initQueryResultList()\" />\r\n");
      out.write("         <input type=\"button\" class=\"button\" value=\"重置(R)\" accesskey=\"R\"  onclick=\"\" />\r\n");
      ...
      out.write("</table>\r\n");
      out.write("<script>\r\n");
      out.write("initTabs('tabView1',Array('系统参数列表'),0,'100%','100%');\r\n");
      out.write("function getDetail(parId, parName){\r\n");
      out.write("\tcreateNewTab('tabView1','参数{'+parName+'}','','/sys/sysParameterConfAction.do?method=toSysParameterConfEdit&parId='+parId,true);\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function toAdd(){\r\n");
      out.write("    createNewTab('tabView1','新增参数','','/sys/sysParameterConfAction.do?method=toSysParameterConfAdd',true);\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      ...
      out.write("    sysParameterConfAction.deleteDataSysParameterConf(checkids,goBack);\r\n");
      out.write("  }\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      ...
      out.write("\t\tsysParameterConfAction.getSysParameterConfList(formObj,showResultList);\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function saveParameter(){\r\n");
      out.write("     if (!validateForm(parameterForm, 1)) {\r\n");
      out.write("            return false;\r\n");
      out.write("        }\r\n");
      out.write("    var formObj=$('parameterForm').serialize(true);\r\n");
      out.write("    sysParameterConfAction.updateDataSysParameterConf(formObj,goBack);\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function addParameter(){\r\n");
      out.write("     if (!validateForm(parameterAddForm, 1)) {\r\n");
      out.write("            return false;\r\n");
      out.write("        }\r\n");
      out.write("     var formObj=$('parameterAddForm').serialize(true);\r\n");
      out.write("     sysParameterConfAction.addDataSysParameterConf(formObj,goBack);\r\n");
      out.write("}\r\n");
      out.write("\r\n");

...
SuccessfullyUpload   :"圖片已上傳成功",
SameName             :"已存在一個相同名字的文件。 該上傳文件將被改名為  \"",
InvalidFileType      :"無效的文件類型",
SecurityError        :"安全性錯誤。 你可能沒有足夠的權限來上傳。 請檢查您的服務器。",
ExceedsSizeLimit     :"上傳圖片超過大小限制",
ConnectorDisable     :"連接器被禁用",
ErrorUpload          :"文件上傳錯誤. 錯誤編碼是:"
};

...
function CleverTabs(self, options) {
    ...
    this.options = $.extend({
        ...
        //Tab用于控制的头模板
        tabHeaderTemplate: '<li id="cleverTabHeaderItem-#{id}" ><div class="t_tab_curl"><div class="t_tab_curm"><div class="t_tab_curr"><a class="close" href="javascript:void(0);" title="关闭"></a><a href="#" title="#{title}">#{label}</a></div></div></div></li>',
        //Tab用于显示的Panel模板
...
CleverTabs.prototype.setupContextMenu = function () {
    ...
    if (!self.options.contextMenu) {
        contextMenu = {
            element: $('<ul id="cleverTabsContextMenu"><div class="gutterLine">'
...
CleverTab.prototype.setLock = function (lock, changeOrgLock) {
    ...
    if (!lock) {
        ...
        var btnClose = $('<a href="javascript:void(0)" class="ui-corner-all" title="Close" style="position: absolute; cursor: pointer; padding: 0px; top: 1px; right: 1px"><span class="ui-icon ui-icon-close" style="position: absolute; padding-bottom: 0px; padding-left: 0px; padding-right: 0px; top: 1px; cursor: pointer; right: 1px; padding-top: 0px;"></span></a>');

	...
	<div data-options="region:'center'" style="width:100%;height:100%; ">
				...
				<%for(int row=1;row<=pdwPortalLayout.getLayoutRows().intValue();row++){
				    for(int i=0;i<portalLayoutPanelLst.size();i++){
					    if(row== portalLayoutPanelLst.get(i).getPanelRow().intValue()){%><td style="width:30%;" class="portal-column-td" colspan="<%= portalLayoutPanelLst.get(i).getPanelColspns().intValue()%>" rowspan="<%= portalLayoutPanelLst.get(i).getPanelRowspns().intValue()%>">
					     <div  style="width:100%;">

...
/**
 * Class ColumnHeaderDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ColumnHeaderDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ColumnHeaderDescriptor() {
        super();
        xmlName = "ColumnHeader";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ColumnHeader target = (ColumnHeader) object;
    ...
    } //-- com.regaltec.rsas.common.xmlparser.ColumnHeaderDescriptor()
    ...
    {
        return com.ccssoft.rsas.common.xmlparser.ColumnHeader.class;

...
public class DataReport implements java.io.Serializable {
     ...
     * ԭ���ݿ�����
     */
    private java.lang.String _dataReportDatabaseType;
    ...
    public DataReport() {
        super();
    } //-- com.regaltec.rsas.common.config.configparser.DataReport()
    ...
    /**
     * Returns the value of field 'dataReportDatabaseType'. The
     * field 'dataReportDatabaseType' has the following
     * description: ԭ���ݿ�����
     * 
     * @return the value of field 'dataReportDatabaseType'.
     */
    public java.lang.String getDataReportDatabaseType()
    {
        return this._dataReportDatabaseType;
    } //-- java.lang.String getDataReportDatabaseType() 
    ...
    /**
     * Sets the value of field 'dataReportDatabaseType'. The field
     * 'dataReportDatabaseType' has the following description:
     * ԭ���ݿ�����
     * 
     * @param dataReportDatabaseType the value of field
     * 'dataReportDatabaseType'.
     */
    public void setDataReportDatabaseType(java.lang.String dataReportDatabaseType)
    {
        this._dataReportDatabaseType = dataReportDatabaseType;
    } //-- void setDataReportDatabaseType(java.lang.String) 
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.ccssoft.rsas.common.config.configparser.DataReport) Unmarshaller.unmarshal(com.ccssoft.rsas.common.config.configparser.DataReport.class, reader);

...
/**
 * Class DataCellAreaDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class DataCellAreaDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public DataCellAreaDescriptor() {
        super();
        xmlName = "DataCellArea";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                DataCellArea target = (DataCellArea) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- com.regaltec.rsas.common.xmlparser.DataCellAreaDescriptor()
    ...
    {
        return com.ccssoft.rsas.common.xmlparser.DataCellArea.class;

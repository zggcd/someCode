 ...
 */
public class RTFTemplateField implements java.io.Serializable {
    ...
    public RTFTemplateField() {
        super();
    } //-- com.regaltec.rsas.common.xmlparser.RTFTemplateField()
     ...
     * has the following description: ���ɵ�Fieldlist��xml����
     * 
     ...
     * the following description: ���ɵ�Fieldlist��xml����
     * 
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.ccssoft.rsas.common.xmlparser.RTFTemplateField) Unmarshaller.unmarshal(com.ccssoft.rsas.common.xmlparser.RTFTemplateField.class, reader);

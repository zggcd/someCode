...
/**
 * Class IntegrationLayerDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class IntegrationLayerDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public IntegrationLayerDescriptor() {
        super();
        xmlName = "IntegrationLayer";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                IntegrationLayer target = (IntegrationLayer) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _integrationDatabaseType
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_integrationDatabaseType", "IntegrationDatabaseType", org.exolab.castor.xml.NodeType.Attribute);
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                IntegrationLayer target = (IntegrationLayer) object;
                return target.getIntegrationDatabaseType();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    IntegrationLayer target = (IntegrationLayer) object;
                    target.setIntegrationDatabaseType( (java.lang.String) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _integrationDatabaseType
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
    ...
    } //-- com.regaltec.rsas.common.config.configparser.IntegrationLayerDescriptor()
    ...
    {
        return com.ccssoft.rsas.common.config.configparser.IntegrationLayer.class;

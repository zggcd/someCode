 ...
 */
public class SetDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SetDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _isSliced
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(byte.class, "_isSliced", "isSliced", org.exolab.castor.xml.NodeType.Attribute);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                Set target = (Set) object;
                if(!target.hasIsSliced())
                    return null;
                return new Byte(target.getIsSliced());
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    if (value == null) {
                        target.deleteIsSliced();
                        return;
                    }
                    target.setIsSliced( ((Byte)value).byteValue());
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
    ...
    } //-- com.regaltec.rsas.common.xmlparser.chart.pie.SetDescriptor()
    ...
    {
        return com.ccssoft.rsas.common.xmlparser.chart.pie.Set.class;

...
/**
 * Class CollectionLayerDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class CollectionLayerDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CollectionLayerDescriptor() {
        super();
        xmlName = "CollectionLayer";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                CollectionLayer target = (CollectionLayer) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _collectionDatabaseType
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_collectionDatabaseType", "CollectionDatabaseType", org.exolab.castor.xml.NodeType.Attribute);
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                CollectionLayer target = (CollectionLayer) object;
                return target.getCollectionDatabaseType();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    CollectionLayer target = (CollectionLayer) object;
                    target.setCollectionDatabaseType( (java.lang.String) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _collectionDatabaseType
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
    ...
    } //-- com.regaltec.rsas.common.config.configparser.CollectionLayerDescriptor()
    ...
    {
        return com.ccssoft.rsas.common.config.configparser.CollectionLayer.class;

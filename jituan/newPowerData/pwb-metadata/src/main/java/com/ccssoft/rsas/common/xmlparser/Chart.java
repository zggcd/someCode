...
public class Chart implements java.io.Serializable {
     ...
     * ��64λ������ͼ������
     */
    private java.lang.String _chartContent;
    ...
    public Chart() {
        super();
    } //-- com.regaltec.rsas.common.xmlparser.Chart()
    ...
    /**
     * Returns the value of field 'chartContent'. The field
     * 'chartContent' has the following description: ��64λ������ͼ������
     * 
     * @return the value of field 'chartContent'.
     */
    public java.lang.String getChartContent()
    {
        return this._chartContent;
    } //-- java.lang.String getChartContent() 

    /**
     * Returns the value of field 'controlID'. The field
     * 'controlID' has the following description: ��ģ����ͼ��ؼ���ID
     * 
    ...
    /**
     * Sets the value of field 'chartContent'. The field
     * 'chartContent' has the following description: ��64λ������ͼ������
     * 
     * @param chartContent the value of field 'chartContent'.
     */
    public void setChartContent(java.lang.String chartContent)
    {
        this._chartContent = chartContent;
    } //-- void setChartContent(java.lang.String) 

    /**
     * Sets the value of field 'controlID'. The field 'controlID'
     * has the following description: ��ģ����ͼ��ؼ���ID
     * 
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.ccssoft.rsas.common.xmlparser.Chart) Unmarshaller.unmarshal(com.ccssoft.rsas.common.xmlparser.Chart.class, reader);

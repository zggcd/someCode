...
public class CollectionLayerConf implements Serializable
{
   ...
   private String collectionDatabaseType;
   ...
   public String getCollectionDatabaseType()
   {
      return collectionDatabaseType;
   }
   public void setCollectionDatabaseType(String collectionDatabaseType)
   {
      this.collectionDatabaseType = collectionDatabaseType;
   }
}

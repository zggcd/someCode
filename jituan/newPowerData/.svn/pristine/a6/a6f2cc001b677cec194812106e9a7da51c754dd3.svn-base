...
/**
 * Class EvaluationConditionValueDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class EvaluationConditionValueDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public EvaluationConditionValueDescriptor() {
        super();
        xmlName = "EvaluationConditionValue";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                EvaluationConditionValue target = (EvaluationConditionValue) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _dateValue1
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.ccssoft.rsas.common.xmlparser.types.EvaluationConditionValueDateValue1Type.class, "_dateValue1", "DateValue1", org.exolab.castor.xml.NodeType.Attribute);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    EvaluationConditionValue target = (EvaluationConditionValue) object;
                    target.setDateValue1( (com.ccssoft.rsas.common.xmlparser.types.EvaluationConditionValueDateValue1Type) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setHandler( new org.exolab.castor.xml.handlers.EnumFieldHandler(com.ccssoft.rsas.common.xmlparser.types.EvaluationConditionValueDateValue1Type.class, handler));
        desc.setImmutable(true);
        addFieldDescriptor(desc);
        ...
        desc.setValidator(fieldValidator);
        //-- _dateValue2
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.ccssoft.rsas.common.xmlparser.types.EvaluationConditionValueDateValue2Type.class, "_dateValue2", "DateValue2", org.exolab.castor.xml.NodeType.Attribute);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    EvaluationConditionValue target = (EvaluationConditionValue) object;
                    target.setDateValue2( (com.ccssoft.rsas.common.xmlparser.types.EvaluationConditionValueDateValue2Type) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setHandler( new org.exolab.castor.xml.handlers.EnumFieldHandler(com.ccssoft.rsas.common.xmlparser.types.EvaluationConditionValueDateValue2Type.class, handler));
        desc.setImmutable(true);
        addFieldDescriptor(desc);
        ...
        //-- _evaluationValues
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.ccssoft.rsas.common.xmlparser.EvaluationValues.class, "_evaluationValues", "EvaluationValues", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                EvaluationConditionValue target = (EvaluationConditionValue) object;
                return target.getEvaluationValues();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    EvaluationConditionValue target = (EvaluationConditionValue) object;
                    target.setEvaluationValues( (com.ccssoft.rsas.common.xmlparser.EvaluationValues) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new com.ccssoft.rsas.common.xmlparser.EvaluationValues();
            }
        } );
        desc.setHandler(handler);
        ...
        //-- validation code for: _evaluationValues
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    } //-- com.regaltec.rsas.common.xmlparser.EvaluationConditionValueDescriptor()
    ...
    {
        return com.ccssoft.rsas.common.xmlparser.EvaluationConditionValue.class;

...
/**
 * Class PortletContents.
 * 
 * @version $Revision$ $Date$
 */
public class PortletContents implements java.io.Serializable {
    ...
    public PortletContents() {
        super();
        _portletContentList = new Vector();
    } //-- com.regaltec.rsas.common.xmlparser.PortletContents()
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.ccssoft.rsas.common.xmlparser.PortletContents) Unmarshaller.unmarshal(com.ccssoft.rsas.common.xmlparser.PortletContents.class, reader);

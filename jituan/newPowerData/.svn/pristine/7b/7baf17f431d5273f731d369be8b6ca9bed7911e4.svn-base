 ...
 */
public class IndicatorTemp implements java.io.Serializable {
    ...
    public IndicatorTemp() {
        super();
        _portletContentList = new Vector();
    } //-- com.regaltec.rsas.common.xmlparser.IndicatorTemp()
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.ccssoft.rsas.common.xmlparser.IndicatorTemp) Unmarshaller.unmarshal(com.ccssoft.rsas.common.xmlparser.IndicatorTemp.class, reader);

...
/**
 * Class PublicConditionDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class PublicConditionDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PublicConditionDescriptor() {
        super();
        xmlName = "PublicCondition";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                PublicCondition target = (PublicCondition) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- com.regaltec.rsas.common.xmlparser.PublicConditionDescriptor()
    ...
    {
        return com.ccssoft.rsas.common.xmlparser.PublicCondition.class;

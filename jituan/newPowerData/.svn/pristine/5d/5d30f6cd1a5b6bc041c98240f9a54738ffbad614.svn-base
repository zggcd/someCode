...
//upload trips ,add by Shubin Lin ,Feb 25th ,2013
SuccessfullyUpload   :"Your file has been successfully uploaded",
SameName             :"A file with the same name is already available. The uploaded file has been renamed to \"",
InvalidFileType      :"Invalid file type",
SecurityError        :"Security error. You probably don't have enough permissions to upload. Please check your server.",
ExceedsSizeLimit     :"The upload file exceeds the size limit",
ConnectorDisable     :"The connector is disabled",
ErrorUpload          :"Error on file upload. Error number:"
};

...
/**
 * ��Expandable���ʹ�ã�Ŀǰֻ֧������ɸѡ����
 * 
 * @version $Revision$ $Date$
 */
public class ExpandConditions implements java.io.Serializable {
    ...
    public ExpandConditions() {
        super();
        _conditionList = new Vector();
    } //-- com.regaltec.rsas.common.xmlparser.ExpandConditions()
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.ccssoft.rsas.common.xmlparser.ExpandConditions) Unmarshaller.unmarshal(com.ccssoft.rsas.common.xmlparser.ExpandConditions.class, reader);

...
SuccessfullyUpload   :"图片已上传成功",
SameName             :"已存在一个相同名字的文件. 该上传文件将被改名为  \"",
InvalidFileType      :"无效的文件类型",
SecurityError        :"安全性错误。 你可能没有足够的权限来上传。 请检查您的服务器。",
ExceedsSizeLimit     :"上传图片超过大小限制",
ConnectorDisable     :"连接器被禁用",
ErrorUpload          :"文件上传错误. 错误编号是:"

...
FCKConfig.ToolbarSets["Default"] = [
	...
	['Link','Unlink','Anchor'],
	['Flash','Table','Rule','Smiley','SpecialChar','Image'],//'Image',暂时屏蔽图片上传功能
	'/',
...
FCKConfig.ContextMenu = ['Generic','Link','Anchor','Image','BulletedList','NumberedList','Table','DivContainer'] ;
...
FCKConfig.FontNames= '宋体;黑体;隶书;行楷;楷体;Courier New;Arial;Comic Sans MS;Tahoma;Times New Roman;Verdana';
FCKConfig.FontSizes		= '9px;10px;12px;14px;16px;18px;24px;26px;28px;32px;smaller;larger;xx-small;x-small;small;medium;large;x-large;xx-large' ;
...
var _QuickUploadExtension = _QuickUploadLanguage == 'jpp' ? 'jsp' : _QuickUploadLanguage ;
...
FCKConfig.ImageUploadURL ='/imageUpload/file?Type=Image';
...
'angry_smile.gif','angel_smile.gif','shades_smile.gif','devil_smile.gif',
'cry_smile.gif','lightbulb.gif','thumbs_down.gif','thumbs_up.gif','heart.gif','broken_heart.gif','kiss.gif','envelope.gif'] ;
